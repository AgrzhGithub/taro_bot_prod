...
REFERRAL_BONUS_INVITED = int(os.getenv("REFERRAL_BONUS_INVITED", "3"))    # новичку по приглашению
REFERRAL_BONUS_REFERRER = int(os.getenv("REFERRAL_BONUS_REFERRER", "3"))  # пригласившему
DEFAULT_FREE_CREDITS     = int(os.getenv("DEFAULT_FREE_CREDITS", "0"))     # на старт без промо/приглашения
PROMO_DEFAULT_CREDITS    = int(os.getenv("PROMO_DEFAULT_CREDITS", "3"))   # если промокод маркетинговый без своих настроек
