...
from services.billing import (
    ...
    pass_is_active,
    pluralize_messages               # проверка активности PASS без списаний
)
...
async def start_inline(message: Message):
    ...
    #sent2 = await _send_daily_media_with_caption(message, None, welcome2)
    # not sent2:
...
async def show_profile(cb: CallbackQuery):
    ...
    txt = (f"👤 Ваш профиль\n\n"
           f"💰 Баланс: {pluralize_messages(balance)}f\n"
           f"{pass_line}\n\n"
