...
buy_kb = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="5 сообщений — 50₽")],
        [KeyboardButton(text="10 сообщений — 99₽")],
        [KeyboardButton(text="30 сообщений — 199₽")],
...
@router.message(lambda msg: msg.text in ["5 сообщений — 80₽", "10 сообщений — 119₽", "30 сообщений — 199₽"])
async def buy_package(message: Message):
    ...
    if message.text.startswith("5"):
        ...
        credits, price = 10, 119
    else:
        credits, price = 30, 199
